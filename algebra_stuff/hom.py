...
class HilbertTangentSpace:
    def __init__(self, I: PolyRingIdeal):
        """
    ...
    def dim(self):
        return hom_rank(self.J, self.O)
    
    def basis(self):
        return hom(self.J, self.O)
...
def get_nested_modules(I1: PolyRingIdeal, I2: PolyRingIdeal) -> NestedModules:
    # I2 subset of I1
    R = I1.base
